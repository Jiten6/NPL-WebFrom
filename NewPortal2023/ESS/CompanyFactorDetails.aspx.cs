...
{
    public partial class CompanyFactorDetails : System.Web.UI.Page
    {
        ...
        private void Fill_Details(string index, string size)
        {
            ...
            ds = objAppraisal.Fill_ApprisialLIstCompFact(gvList, index, size);
        ...
        protected void lnkBtnDeleteRowSteps_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ViewState["CompanyFactor"] = dtCOInfo;
                    this.gvSteps.DataSource = (DataTable)ViewState["CompanyFactor"];
                    this.gvSteps.DataBind();
                }
                else if (ViewState["BUTTON"].ToString() == "2")
                {
                    ViewState["CompanyPromises"] = dtCOInfo;
                    this.gvSteps.DataSource = (DataTable)ViewState["CompanyPromises"];
                    this.gvSteps.DataBind();
                }
        ...
        protected void lnkBtnAddRowSteps_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["BUTTON"].ToString() == "1")
                {
                    ...
                    ViewState["CompanyFactor"] = dtCOInfo;
                    ViewStateTable = (DataTable)ViewState["CompanyFactor"];
                }
                else if (ViewState["BUTTON"].ToString() == "2")
                {

                    ViewState["CompanyPromises"] = dtCOInfo;
                    ViewStateTable = (DataTable)ViewState["CompanyPromises"];
                }
        ...
        protected void btnFinancials_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objAppraisal.Quarter = ViewState["Quarter"].ToString();
                ds = objAppraisal.Fill_Apprisial((string)(Session["sEmpID"]), Convert.ToString(Session["sCompID"]), "Finanace");
        ...
        protected void btnCompetitiveness_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objAppraisal.Year = ViewState["Year"].ToString();
                objAppraisal.Quarter = ViewState["Quarter"].ToString();
                ds = objAppraisal.Fill_Apprisial((string)(Session["sEmpID"]), Convert.ToString(Session["sCompID"]), "Competitiveness");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    this.gvSteps.DataSource = ds.Tables[0];
                    this.gvSteps.DataBind();
        ...
        protected void btnOperationalExcellence_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objAppraisal.Year = ViewState["Year"].ToString();
                objAppraisal.Quarter = ViewState["Quarter"].ToString();
                ds = objAppraisal.Fill_Apprisial((string)(Session["sEmpID"]), Convert.ToString(Session["sCompID"]), "Operational");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    this.gvSteps.DataSource = ds.Tables[0];
                    this.gvSteps.DataBind();
        ...
        protected void btnPeople_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objAppraisal.Year = ViewState["Year"].ToString();
                objAppraisal.Quarter = ViewState["Quarter"].ToString();
                ds = objAppraisal.Fill_Apprisial((string)(Session["sEmpID"]), Convert.ToString(Session["sCompID"]), "People");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    this.gvSteps.DataSource = ds.Tables[0];
                    this.gvSteps.DataBind();
        ...
        protected void btnFutureReadiness_Click(object sender, EventArgs e)
        {
            ...
            objAppraisal.Year = ViewState["Year"].ToString();
            objAppraisal.Quarter = ViewState["Quarter"].ToString();
            ds = objAppraisal.Fill_Apprisial((string)(Session["sEmpID"]), Convert.ToString(Session["sCompID"]), "FutureReadiness");
            if (ds.Tables[0].Rows.Count > 0)
            {
                this.gvSteps.DataSource = ds.Tables[0];
                this.gvSteps.DataBind();
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["BUTTON"].ToString() == "1")
            {
                Column = "CompanyFactor";
            }
            else if (ViewState["BUTTON"].ToString() == "2")
            {
                Column = "CompanyPromises";
            }
        ...
        protected void btnCompanyFactor_Click(object sender, EventArgs e)
        {
            try
            {
                ViewState["BUTTON"] = "1";
                ...
                objAppraisal.Year = ViewState["Year"].ToString();
                objAppraisal.Quarter = ViewState["Quarter"].ToString();
                ds = objAppraisal.Fill_Apprisial((string)(Session["sEmpID"]), Convert.ToString(Session["sCompID"]), "CompanyFactor");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    this.gvSteps.DataSource = ds.Tables[0];
                    this.gvSteps.DataBind();
        ...
        protected void btnCompanyPromises_Click(object sender, EventArgs e)
        {
            try
            {
                ViewState["BUTTON"] = "2";
                ...
                objAppraisal.Year = ViewState["Year"].ToString();
                objAppraisal.Quarter = ViewState["Quarter"].ToString();
                ds = objAppraisal.Fill_Apprisial((string)(Session["sEmpID"]), Convert.ToString(Session["sCompID"]), "CompanyPromises");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    this.gvSteps.DataSource = ds.Tables[0];
                    this.gvSteps.DataBind();
