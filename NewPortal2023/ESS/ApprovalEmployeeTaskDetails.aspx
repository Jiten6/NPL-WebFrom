<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="ApprovalEmployeeTaskDetails.aspx.cs" Inherits="NewPortal2023.ESS.ApprovalEmployeeTaskDetails" %>
                                                                            ...
                                                                            <asp:GridView ID="gvSteps" runat="server" OnRowUpdating="gvSteps_RowUpdating" OnRowCancelingEdit="gvSteps_RowCancelingEdit" OnRowDataBound="gvSteps_RowDataBound" OnRowEditing="gvSteps_RowEditing" AutoGenerateColumns="False"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Target">
                                                                                        <ItemTemplate>
                                                                                            <asp:TextBox ID="txtTarget" runat="Server" TextMode="MultiLine" ReadOnly="true" CssClass="form-control metric-col" Style="border: 0px; overflow: hidden; resize: none;" Text='<%# Eval("TARGET") %>' />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="% wt" Visible="false">
                                                                                        <ItemTemplate>
                                                                                            <asp:TextBox ID="txtwt" runat="Server" TextMode="MultiLine" ReadOnly="true" CssClass="form-control input-sm datepicker" Text='<%# Eval("TWT") %>' />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Mid Year Review - Progess Made By Employee" Visible="true">
                                                                                        <ItemTemplate>
                                                                                            <asp:TextBox ID="txtMidYrReview" runat="Server" TextMode="MultiLine" CssClass="form-control metric-col" Style="border: 0px; overflow: hidden; resize: none;" Text='<%# Eval("MIDYEARPROGRESS") %>' />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Mid Year Review Remarks By RM">
                                                                                        <ItemTemplate>
                                                                                            <asp:TextBox ID="txtMidYrReviewRM" runat="Server" TextMode="MultiLine" CssClass="form-control metric-col" Style="border: 0px; overflow: hidden; resize: none;" Text='<%# Eval("MIDYEARPROGRESSREVIEWRM") %>' />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Appraiser’s Comments">
                                                                                        <ItemTemplate>
                                                                                            <asp:TextBox ID="txtModiMDRecom" runat="Server" TextMode="MultiLine" CssClass="form-control metric-col" Style="border: 0px; overflow: hidden; resize: none;" Text='<%# Eval("Modified_Score_MDs_Recommendation") %>' />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Remark">
                                                                                        <ItemTemplate>
                                                                                            <asp:TextBox ID="txtRemark" runat="Server" TextMode="MultiLine" CssClass="form-control metric-col" Style="border: 0px; overflow: hidden; resize: none;" Text='<%# Eval("RPT_REMARK") %>' />
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField Visible="false">
                                                                                        <ItemTemplate>
                                                                ...
                                                                <div class="col-12 flex-grow-1" style="overflow-x: scroll; width: 100%">
                                                                    <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvList_RowDataBound" ShowFooter="true" CssClass="table table-bordered table-striped" HtmlEncode="false">
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Appraiser’s Comments">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblApprComm" runat="Server" TextMode="MultiLine" ReadOnly="true" CssClass="metric-col" Style="border: 0px; overflow: hidden; resize: none;" Text='<%# Eval("Modified_Score_MDs_Recommendation") %>' />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
