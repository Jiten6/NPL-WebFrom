<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.master" AutoEventWireup="true" CodeBehind="GratuityNomination.aspx.cs" Inherits="NewPortal2023.ESS.GratuityNomination" %>
                                        ...
                                        <div class="adv-table">
                                            <div id="" class="form-horizontal">
                                                <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
                                                            <h3 class="page-header" style="text-align: center; color: black;">Gratuity Nomination Form</h3>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label for="lblTranche" class="col-sm-3  labels">Sex</label>
                                                            <div class="col-sm-3">
                                                                <asp:DropDownList ID="drpGender" runat="server" CssClass="form-control input-sm-3" Enabled="true">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="lblTranche" class="col-sm-3  labels">Religion</label>
                                                            <div class="col-sm-3">
                                                                <asp:TextBox ID="txtReligion" runat="server" class="form-control input-sm"></asp:TextBox>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label for="lblTranche" class="col-sm-3  labels">Department/Branch</label>
                                                            <div class="col-sm-3">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="lblTranche" class="col-sm-3  labels">Date of appointment</label>
                                                            <div class="col-sm-3">
                                                                <asp:TextBox ID="txtJoinDate" runat="server" class="form-control input-sm"></asp:TextBox>
                                                            </div>
