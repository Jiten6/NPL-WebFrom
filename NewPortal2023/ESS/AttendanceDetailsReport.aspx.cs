...
namespace NewPortal2023.ESS
{
    public partial class AttendanceDetailsReport : System.Web.UI.Page
    {
        ...
        //                        Row.Cells[17].BackColor = System.Drawing.Color.OrangeRed;
        //                    }
        //                }
        ...
        //                        Row.Cells[17].BackColor = System.Drawing.Color.GreenYellow;
        //                    }
        //                }
        ...
        //                    {
        //                        //lblAttRemark.Text = "OT";
        //                        Row.Cells[17].BackColor = System.Drawing.Color.LightPink;
        //                    }
        //                }
        //                else if (lblot.Text != "")
        //                {
        ...
        //                //    }
        //                //}
        //                //if (lnkAppNo.Text == "00195")
        //                //{
        //                //    string var = "OK";
        //                //}
        //                //if (lnkAppNo.Text == "00197")
        //                //{
        //                //    string var1 = "OK";
        //                //}
        //                if (lnkAppNo.Text == "CONSP26")
        //                {
        //                    string var2 = "OK";
        //                }
        //                //if (lnkAppNo.Text == "NP3402")
        //                //{
        //                //    string var2 = "OK";
        //                //}
        //                //if (lnkAppNo.Text == "NP3403")
        //                //{
        //                //    string var2 = "OK";
        //                //}
        //                if (lnkAppNo.Text == "NP5502")
        //                {
        //                    string var2 = "OK";
        //                }
        //                if (lblPunchRmk.Text == "L")
        ...
        //                }
        //                else if (lblStatusShift.Text == "PL")
        //                {
        //                    lblAttRemark.Text = "Privilege Leave";
        //                }
        //                else if (lblStatusShift.Text == "WO")
        //                {
        //                    if (IN_TIME != CompareWith || OUT_TIME != CompareWith)
                    ...
                    if (Row.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        if (lblStatusShift.Text == "GN" || lblStatusShift.Text == "EV" || lblStatusShift.Text == "GS" || lblStatusShift.Text == "MS" || lblStatusShift.Text == "NS")
                        {
                            ...
                            if (lblTotalWorking.Text != "" && lblTotalWorking.Text != "0.00")
                            {
                                ...
                                //{
                                //    lblAttRemark.Text = "Half day Absent";
        ...
        private void OutSideDuty()
        {
            ...
            if (drpEmpCode.SelectedValue == "")
            {
                objNps.EmpCode = txtEmpCode.Text;
            }
            else if (drpEmpCode.SelectedValue != "0")
            {
                objNps.EmpCode = drpEmpCode.Text;
            }
            else
            {
                objNps.EmpCode = "";
                                    ...
                                    if (OutSIdeReason != "")
                                    {
                                        ...
                                        if (lblStat.Text == OutSIde && EpCode.Text == EpMid)
                                        {
                                            if (STATUS == "2")
                                            {
                                                ...
                                                if (Reason_id == "4")
                                                {
                                                    lblAttRemark.Text = "First half /" + OutSIdeReason + "Approved";
                                                    Row.Cells[17].BackColor = System.Drawing.Color.LightGreen;
                                                }
                                                else if (Reason_id == "5")
                                                {
                                                    lblAttRemark.Text = "Second half /" + OutSIdeReason + "Approved";
                                                    Row.Cells[17].BackColor = System.Drawing.Color.LightGreen;
                                                }
                                            }
                                            ...
                                            if (OutSIdeReason == "Sick Leave" && STATUS == "1" && Reason_id == "4")
                                            {
                                                lblAttRemark.Text = "First Half/Sick Leave Applied";
                                                Row.Cells[17].BackColor = System.Drawing.Color.Yellow;
                                            }
                                            if (OutSIdeReason == "Sick Leave" && STATUS == "1" && Reason_id == "5")
                                            {
                                                lblAttRemark.Text = "Second Half/Sick Leave Applied";
                                                Row.Cells[17].BackColor = System.Drawing.Color.Yellow;
                                            }
        ...
        private void Co_applicationchecking()
        {
            ...
            //ds = objCoApp.GetCOListAdmin(Session["sCompID"].ToString(), Session["EmpCode"].ToString(), NewYear);
            ...
            try
            {
                for (int i = 0; Convert.ToBoolean(ds.Tables[0].Rows.Count); i++)
                {
                    if (ds.Tables[0].Rows.Count != i)
                    {
                        ...
                        string rowDate = ds.Tables[0].Rows[i]["FR_DATE"] != DBNull.Value
                    ? Convert.ToDateTime(ds.Tables[0].Rows[i]["FR_DATE"]).ToString("dd-MM-yyyy")
                    : string.Empty;

                        string empMid = ds.Tables[0].Rows[i]["EMP_MID"] != DBNull.Value
                                        ? ds.Tables[0].Rows[i]["EMP_MID"].ToString()
                                        : string.Empty;

                        string status = ds.Tables[0].Rows[i]["STATUSTYPE"] != DBNull.Value
                                        ? ds.Tables[0].Rows[i]["STATUSTYPE"].ToString()
                                        : string.Empty;
                        ...
                        foreach (GridViewRow Row in gvList.Rows)
                        {
                            if (Row.RowType == DataControlRowType.DataRow)
                            {
                                ...
                                if (lblOrigin.Text == rowDate && lnkAppNo.Text == empMid)
                                {
                                    if (status == "APPROVED")
                                    {
                                        lblAttRemark.Text = "Comp Off";
                                    }
                                    else if (status == "SUBMITTED")
                                    {
                                        lblAttRemark.Text = "Comp Off/Approval For Pending";
                                    }
                                }
                            }
                        }
        ...
        //    objNps.EmpName = drpDepartment.SelectedValue;
        ...
        protected void btnGenerateAttendanceReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtFromDate.Text != "" && txtToDate.Text != "" && (drpDptList.SelectedValue != "" || drpDptList.SelectedValue == ""))
                {
                    if (drpType.SelectedValue == "Employee Wise")
                    {
                        if (drpDptList.SelectedValue != "0")
                        {
                            if (drpEmpCode.SelectedValue == "0" || drpEmpCode.SelectedValue == "")
                            {

                                string script = $@"<script type='text/javascript'>alert('Please Select Employee Code.');</script>";
                                ClientScript.RegisterStartupScript(this.GetType(), "alert", script);
                                lblMessage.Text = "Please Select Employee Code";
                                return;
                            }
                        }
                    }
                    ...
                    objNps.drpDpt = drpDptList.SelectedValue;           //DEPARTMENT 0  DE000020
                    objNps.drpEmpCode = drpEmpCode.SelectedValue;       //DRP_EMP_MID ""  NP3403

                    objNps.txtEmpCode = txtEmpCode.Text;                //EMP_MID "" "" 

                    objNps.EmpName = Session["sEmpName"].ToString();    //USER NAME
                    ds = objNps.GenerateAttendanceDetailsReport((string)Session["sCompID"]);
                    ...
                    else if (Convert.ToString(ds.Tables[1].Rows[0]["result"]) == "")
                    {
                        ...
                        dsUP = objNps.UpdateAttendancedetails(MakeChkXml(gvList));
                        ...
                        ReportDataSource datasource1 = new ReportDataSource("Dsattendanced", dsUP.Tables[0]);


                        rptPrint.LocalReport.DataSources.Clear();
                        rptPrint.ProcessingMode = ProcessingMode.Local;
                        rptPrint.LocalReport.ReportPath = @"ESS\attendancedetailsReport.rdlc";
                        ...
                        // Store the download in session
                        Session["reportBytes"] = bytes;
                        Session["contentType"] = contentType;
                        Session["filename"] = $"Attendance_Details_Report_{txtFromDate.Text}_{txtToDate.Text}_{txtEmpCode.Text}.xls";
                        rptPrint.Visible = false;
                        // Call JavaScript to trigger iframe download and monitor cookie
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "downloadScript", "startAttendanceDownload();", true);
                        ...
                        //string filename = "Attendance_Details_Report_" + txtFromDate.Text + "/" + txtToDate.Text + "/" + txtEmpCode.Text + ".xls";
                        ...
                        //rptPrint.LocalReport.DisplayName = "Attendance_Details_Report_" + txtFromDate.Text + "/" + txtToDate.Text + "/" + drpDptList.SelectedValue + "";
                        //rptPrint.LocalReport.DataSources.Add(datasource1);
        ...
        {
            objNps.EmpCode = drpDptList.SelectedValue;
            ds = objNps.Fillemployee();
        ...
        private string MakeChkXml(GridView gvList)
        {
            ...
            {
                sbMissPunch.Append("<ADREPORT EMP_CODE='" + objcommon.ReplaceSpecialCharacters(((Label)gvr.FindControl("lnkAppNo")).Text.Trim()) + "'");
                ...
                sbMissPunch.Append(" GEOLOCDETAILS='" + objcommon.ReplaceSpecialCharacters(((Label)gvr.FindControl("lnkGeoLocation")).Text.Trim()) + "'/>");
            }
