...
{
    public partial class ApprovalHREmployeeTaskDetails : System.Web.UI.Page
    {
        ...
        private void FillFinYear()
        {
            ...
            {
                Response.Redirect("~/ESS/ApprovalHREmployeeTaskDetails.aspx", true);
            }
        ...
        private string MakeDetailsXml(string Column)
        {
            ...
            foreach (GridViewRow gvr in this.gvSteps.Rows)
            {
                ...
                string hrremarks = objcommon.ReplaceSpecialCharacters(((TextBox)gvr.FindControl("txtHRRemark")).Text);
                ...
                sbCODetails.Append(" HRREMARKS='" + hrremarks + "'/>");
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (confirmValue == "Yes")
                {
                    ...
                    if (objAppraisal.XML == "Please enter remark.")
                    {
                        ...
                        lblMessageList.Text = "Please enter remark.";
                    ...
                    ds = objAppraisal.UpdateParamApprisalHR(Column, Convert.ToString(Session["sCompID"]), (string)(Session["sEmpCode"]));
        ...
        private void SENDPMSMAIL(string Column)
        {
            try
            {
                ...
                using (MailMessage empMail = new MailMessage())
                {
                    ...
                    string subject = "Do Not Reply: PMS - KRA Revised";
                    string empBody =
                    "Dear Sir/Madam,<br/><br/>" +
                    "This is to inform you that KRA's for " + Column + " has been revised by HR.<br/><br/>" +
                ...
                using (MailMessage rmMail = new MailMessage())
                {
                    ...
                    string rmBody =
                    "Dear Sir/Madam,<br/><br/>" +
                    "This is to inform you that KRA's has been revised for " + Column + " of <strong>Mr. " + makerName + "</strong>.<br/><br/>" +
                    "<strong>Portal Access:</strong> <a href='https://npl.sequelgroup.co.in/ESS/Login.aspx'>https://npl.sequelgroup.co.in/ESS/Login.aspx</a><br/><br/>" +
                ...
                using (MailMessage hrMail = new MailMessage())
                {
                    ...
                    string hodBody =
                    "Dear Sir/Madam,<br/><br/>" +
                    "This is to inform you that KRA's has been revised succesfully for " + Column + " of <strong>Mr. " + makerName + "</strong>.<br/><br/>" +
                    "<strong>Portal Access:</strong> <a href='https://npl.sequelgroup.co.in/ESS/Login.aspx'>https://npl.sequelgroup.co.in/ESS/Login.aspx</a><br/><br/>" +
                    "Thank you for your prompt attention to this matter.<br/><br/>" +
                    "<strong>With Best Regards,<br/>HR Team</strong>";
