...
namespace NewPortal2023.ESS
{
    public partial class AuditReport : System.Web.UI.Page
    {
        ...
        protected void drpType_Report_Selectedchanges(object sender, EventArgs e)
        {
            ...
            clearFields();
            AttendanceReportPanel.Visible = false;
            ...
            if (ddlreportdrop.SelectedItem != null && ddlreportdrop.SelectedItem.Text != "")
            {
                ...
                if (selectedOption == "Attendance Report")
                {
                    AttendanceReportPanel.Visible = true;
                }
        ...
        //        ds = objExp.Fill_AttendanceReport();
        ...
        //        string fileName = $"AttendanceReport_{txtFromDate.Text}_{txtToDate.Text}.xls";
        ...
        protected void btnGenerateAttendanceReport_Click(object sender, EventArgs e)
        {
            if (ValidateInputs())
            {
                ...
                rptPrint.Visible = false;
                ReportDataSource datasourceDomAll = new ReportDataSource("dtAttendanceReport", ds.Tables[0]);

                rptPrint.LocalReport.DataSources.Clear();
                rptPrint.LocalReport.ReportPath = @"Reports/AttendanceReport.rdlc";
                rptPrint.LocalReport.DataSources.Add(datasourceDomAll);
                rptPrint.LocalReport.Refresh();

                byte[] bytes = rptPrint.LocalReport.Render("PDF", null, out contentType, out encoding, out extension, out streamIds, out warnings);
                string fileName = $"AttendanceReport_{txtFromDate.Text}_{txtToDate.Text}.pdf";
