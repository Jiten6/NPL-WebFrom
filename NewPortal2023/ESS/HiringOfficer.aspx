<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="HiringOfficer.aspx.cs" Inherits="NewPortal2023.ESS.HiringOfficer" %>
                                ...
                                <asp:View ID="vwList" runat="server">
                                    <div class="adv-table">
                                        ...
                                        <div class="col-lg-6">
                                                ...
                                                <label for="lblTranche" class="col-sm-6  labels">Select Employee Type</label>
                                                <div class="col-sm-6">
                                                    <asp:DropDownList ID="drpEmpType" CssClass="form-control input-sm-3" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpEmpType_SelectedIndexChanged">
                                        ...
                                        <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" CssClass="display table table-bordered table-striped dynamic-table"
                                            OnPageIndexChanging="gvAssUserDataPointList_PageIndexChanging" DataKeyNames="ENTRY_AID" OnRowDataBound="gvList_RowDataBound"
                                            OnRowEditing="gvList_RowEditing" OnRowUpdating="gvList_RowUpdating" OnRowCancelingEdit="gvList_RowCancelingEdit">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField Visible="true" HeaderText="Action Type" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="drpAction" runat="server" CssClass="form-control input-sm-3" AutoPostBack="true" Enabled="false">
                                                ...
                                                <asp:TemplateField Visible="true" HeaderText="Remark" ItemStyle-Width="200px">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtRemarks" runat="Server" CssClass="form-control input-sm" MaxLength="100" Enabled="false" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField Visible="true">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkBtnView" runat="server" Text="View" CssClass="btn btn-info" OnClick="lnkBtnView_Click" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <label for="lblTranche" class="col-sm-3 labels">Aadhar Number<span style="color: Red;">*</span></label>

                                                            <div class="col-sm-3">
                                                                <asp:TextBox ID="txtAadharNo" runat="server" onkeydown="return CheckNumeric(event);" MaxLength="12" AutoPostBack="true" class="form-control input-sm" ReadOnly="true"></asp:TextBox>
                                                            </div>

                                                            <label for="lblTranche" class="col-sm-3  labels">Pan No<span style="color: Red;">*</span></label>
                                                            <div class="col-sm-3">
                                                                <asp:TextBox ID="txtPanNo" runat="server" placeholder="PAN No" AutoPostBack="true" MaxLength="10" class="form-control input-sm" ReadOnly="true"></asp:TextBox>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <asp:TextBox ID="txtMobileNumber" runat="server" class="form-control input-sm" ReadOnly="true"></asp:TextBox>
                                                            </div>

                                                            <label for="lblTranche" class="col-sm-3  labels">Aadhar-PAN Link Status<span style="color: Red;">*</span></label>
                                                            <div class="col-sm-3">
                                                                <asp:Label ID="lblAPLinkStatus" runat="server" Text="" Enabled="false"></asp:Label>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <asp:TextBox ID="txtAadharNoPer" runat="server" AutoCompleteType="Disabled" AutoPostBack="true" class="form-control input-sm" MaxLength="12" ReadOnly="true"></asp:TextBox>
                                                  ...
                                                  <%--  <div id="div3" runat="server">
                                                    ...
                                                    <%--<div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <asp:TextBox ID="txtAdd1" runat="server" class="form-control input-sm" AutoCompleteType="Disabled" ReadOnly="true"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <asp:TextBox ID="txtAdd2" runat="server" class="form-control input-sm" AutoCompleteType="Disabled" ReadOnly="true"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>--%>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <asp:TextBox ID="txtAdd2" runat="server" ReadOnly="true" class="form-control input-sm" AutoCompleteType="Disabled" TextMode="MultiLine"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12" runat="server" visible="false">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <asp:TextBox ID="txtAdd3" runat="server" class="form-control input-sm" AutoCompleteType="Disabled" ReadOnly="true"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <asp:TextBox ID="txtExpDOJ" runat="server" CssClass="form-control input-sm datepicker" AutoCompleteType="Disabled" ReadOnly="true"></asp:TextBox>
                                                            </div>
                                                            <label for="lblTranche" class="col-sm-3  labels">Remarks<span style="color: Red;"></span></label>
                                                            <div class="col-sm-3">
                                                                <asp:TextBox ID="txtRemk" runat="server" TextMode="MultiLine" class="form-control input-sm" AutoCompleteType="Disabled" ReadOnly="true"></asp:TextBox>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group" id="divfileUploadAadhar" runat="server" visible="false">
                                                                ...
                                                                <asp:TemplateField HeaderText="Uploaded Files">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="lnkBtnOpenFileAadhar" runat="server" Text='<%# Eval("FILENAME") %>'
                                                                            OnClick="lnkBtnOpenFileAadhar_Click" />
                                                                    </ItemTemplate>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group" id="divfileUploadPan" runat="server" visible="false">
                                                                ...
                                                                <asp:TemplateField HeaderText="Uploaded Files">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="lnkBtnOpenFilesPan" runat="server" Text='<%# Eval("FILENAME") %>'
                                                                            OnClick="lnkBtnOpenFilesPan_Click" />
                                                                    </ItemTemplate>
                                                                    <ItemStyle CssClass="GridViewItem" Width="90%" BackColor="white" />
                                                                    <HeaderStyle CssClass="GridViewHeader" />
                                                                </asp:TemplateField>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group" id="divfileUploadEduc" runat="server" visible="false">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Uploaded Files">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="lnkBtnOpenFilesEduc" runat="server" Text='<%# Eval("FILENAME") %>'
                                                                                OnClick="lnkBtnOpenFilesEduc_Click" />
                                                                        </ItemTemplate>
                                                                        <ItemStyle CssClass="GridViewItem" Width="90%" BackColor="white" />
                                                                        <HeaderStyle CssClass="GridViewHeader" />
                                                                    </asp:TemplateField>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group" id="divfileUploadCC" runat="server" visible="false">
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Uploaded Files">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="lnkBtnOpenFilesCC" runat="server" Text='<%# Eval("FILENAME") %>'
                                                                                OnClick="lnkBtnOpenFilesCC_Click" />
                                                                        </ItemTemplate>
                                                                        <ItemStyle CssClass="GridViewItem" Width="90%" BackColor="white" />
                                                                        <HeaderStyle CssClass="GridViewHeader" />
                                                                    </asp:TemplateField>
                                                    ...
                                                    <div id="divAction" runat="server" class="col-lg-12">
                                                        <div class="form-group">
                                                            <div class="col-sm-12 row">
                                                                <div class="col-sm-2">
                                                                </div>
                                                                <label class="col-sm-1 labels">Action<span style="color: Red;">*</span> :</label>
                                                                <div class="col-sm-3">
                                                                    <asp:DropDownList ID="drpActionStatus" runat="server" CssClass="form-control input-sm-3" Enabled="true">
                                                                        <asp:ListItem Value="">---Select One---</asp:ListItem>
                                                                ...
                                                                <label class="col-sm-2 labels">Remark :</label>
                                                                <div class="col-sm-3">
                                                                    <asp:TextBox ID="txtRemarkStatus" runat="server" AutoPostBack="false" MaxLength="10" class="form-control input-sm" TextMode="MultiLine"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            &emsp;
                                                            <div class="col-sm-12" style="text-align: center;">
                                                                ...
                                                                <asp:Button ID="btnClose" runat="server" CssClass="btn btn-danger" Text="Cancel" OnClick="btnClose_Click" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
