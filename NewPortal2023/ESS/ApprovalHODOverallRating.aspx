<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="ApprovalHODOverallRating.aspx.cs" Inherits="NewPortal2023.ESS.ApprovalHODOverallRating" %>
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="flex-grow-1">
                                <header class="panel-heading" style="background-color: darkcyan">
                                    <h3 style="color: white">Overall Rating Approval(HOD)</h3>
                                </header>
                                            ...
                                            <div class="col-12" id="divKRAFin" runat="server" visible="false">
                                                ...
                                                <div id="movingNoteContainer" runat="server">
                                                    <marquee behavior="scroll" direction="left" scrollamount="5" onmouseover="this.stop();" onmouseout="this.start();">
                                                        Please approve KRAs first before Overall Rating Approval.
                                                    </marquee>
                                                </div>
                                                                    ...
                                                                    <asp:GridView ID="gvSummary" runat="server" AutoGenerateColumns="False"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="HOD Action">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txtHODAction" runat="Server" Font-Bold="true" Text='<%# Eval("HOD_ACTION") %>' Style="border: 0px;" ReadOnly="true" />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="HOD Remark">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txtHODRmk" runat="Server" Font-Bold="true" Text='<%# Eval("HOD_REMARK") %>' Style="border: 0px;" ReadOnly="true" />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                        </Columns>
                                                                        <EmptyDataTemplate>
                                                                        ...
                                                                        <ContentTemplate>
                                                                            <asp:GridView ID="gvList" AutoGenerateColumns="False" runat="server"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField Visible="true" HeaderText="KRA Rating(RM)" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="600px">
                                                                                        <ItemTemplate>
                                                                                    ...
                                                                                    <asp:TemplateField Visible="true" HeaderText="Leadership Behaviour(RM)" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px">
                                                                                        <ItemTemplate>
