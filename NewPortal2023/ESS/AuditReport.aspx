<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="AuditReport.aspx.cs" Inherits="NewPortal2023.ESS.AuditReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                                ...
                                                <label class="col-sm-3 col-form-label" Style="font-size: 20px;">Select Report Type</label>
                                                 <div class="col-sm-3">
                                                        <asp:DropDownList ID="ddlreportdrop" runat="server" CssClass="form-control select2" Style="width: 100%;"  OnSelectedIndexChanged="drpType_Report_Selectedchanges" AutoPostBack="true">
                                                            ...
                                                            <asp:ListItem Value="Attendance Report" Text="Attendance Report"></asp:ListItem>
    ...
    <!--Attendance Report -->
    <asp:Panel ID="AttendanceReportPanel" runat="server" Visible="false" CssClass="card card-default">
        <div class="card-body">
            <div class="border-container form-group">
                <div class="col-12">
                    <asp:Label ID="Label3" runat="server" Text="Attendance Report" CssClass="card-title" Style="font-size: 24px;"></asp:Label>
                </div>
                &emsp;
                <fieldset>
                  <%--  <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12" style="text-align: center; margin-top: 40px">
                            <asp:Button ID="btnGenerate" runat="server" OnClick="btnGenerateAttendanceReport_Click" Text="Generate" CssClass="btn btn-warning" />
                        </div>
                    </div>
                </fieldset>
            </div>
