<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="InvestmentDetailsUploadsNF.aspx.cs" Inherits="NewPortal2023.ESS.InvestmentDetailsUploadsNF" %>
                                ...
                                <div class="panel-body">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <asp:LinkButton ID="lnkOther" runat="server" Style="font-size: 20px; font-weight: bold; color: darkcyan;"
                                                                OnClick="lnkOther_Click" Visible="true" AutoPostBack="true" Class="underline" OnClientClick="showLoader();">1. Employee's Information</asp:LinkButton>
                                            ...
                                            <div id="OtherDetails" visible="true" runat="server" class="flex-container" style="display: flex; flex-direction: column; gap: 10px; margin-top: 1.5%; padding: 1.5%;">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group" style="margin-top: -1cm;">
                                                <asp:LinkButton ID="lblInvDetails" runat="server" Style="font-size: 20px; font-weight: bold; color: darkcyan;"
                                                    OnClick="lblInvDetails_Click" Visible="true" AutoPostBack="true" Class="underline" OnClientClick="showLoader();">2. Investment Declaration</asp:LinkButton>
                                            ...
                                            <div id="InvDetails" visible="true" runat="server" class="flex-container" style="display: flex; flex-direction: column; gap: 10px; margin-top: 1.5%; padding: 1.5%;">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <asp:LinkButton ID="lnkRent" runat="server" Style="font-size: 20px; font-weight: bold; color: darkcyan;"
                                                    OnClick="lnkRent_Click" Visible="true" AutoPostBack="true" Class="underline" OnClientClick="showLoader();">3. Rent Declaration</asp:LinkButton>
                                            ...
                                            <div id="RentDetails" visible="true" runat="server" class="flex-container" style="display: flex; flex-direction: column; gap: 10px; margin-top: 1.5%; padding: 1.5%;">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <asp:LinkButton ID="lnk12" runat="server" Style="font-size: 20px; font-weight: bold; color: darkcyan;"
                                                    OnClick="lnk12_Click" Visible="true" AutoPostBack="true" Class="underline" OnClientClick="showLoader();">4. Interest on Housing Loan / Details of Income / (Loss) From Other Than Salary</asp:LinkButton>
                                            ...
                                            <div id="TwelveDetails" visible="true" runat="server" class="form-group flex-container" style="display: flex; flex-direction: column; gap: 10px; margin-top: 1.5%; padding: 1.5%;">
...
<br />
                                                    <div id="tbl12B" runat="server" visible="false" class="form-group" style="margin: 5px; margin-left: -0px;">
                                                        <div class="form-group">
                                                            <asp:LinkButton ID="lnk12b" runat="server" Style="font-size: 20px; font-weight: bold; color: darkcyan;"
                                                                OnClick="lnk12b_Click" Visible="true" AutoPostBack="true" Class="underline" OnClientClick="showLoader();">5. Details of Income From Previous Employer</asp:LinkButton>
                                                            <asp:Label ID="lbl12bLable" Visible="false" runat="server" CssClass="tableTitle" ForeColor="#205A94"
                                                        ...
                                                        <div class="form-group flex-container" id="TwelveBDetails" visible="true" runat="server" style="display: flex; flex-direction: column; gap: 10px; margin-top: 1.5%; padding: 1.5%;">
                                                ...
                                                <div class="form-group" id="div12BUpload" runat="server" style="border: 2px solid gray; padding: 10px; margin-top: 10px;">
                                                    ...
                                                    <asp:LinkButton ID="lnkDownload12BSupport" runat="server" Style="font-weight: bold;"
                                                        OnClick="lnkDownload12BSupport_Click" ForeColor="Blue">Download Saved Documents</asp:LinkButton>
                                                </div>
                                                            </div>
                                                        </div>
