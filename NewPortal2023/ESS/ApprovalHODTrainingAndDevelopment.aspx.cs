...
{
    public partial class ApprovalHODTrainingAndDevelopment : System.Web.UI.Page
    {
        ...
        private void Fill_Details(string index, string size)
        {
            ...
            //objAppraisal.EmpMakerMID = ViewState["EmpCode"].ToString();
        ...
        private void ManBehaSkill_Click()
        {
            mv.SetActiveView(vwList);
            divGVSELF.Visible = true;
        ...
        protected void BtnSaveChanges_Click(object sender, EventArgs e)
        {
            ...
            if (ds.Tables[0].Rows[0]["STATUS"].ToString() == "6")
            {
                objAppraisal.Flag = "HOD";
            ...
            objAppraisal.XML = MakeXml(GVSELF);
            objAppraisal.Year = ViewState["Year"].ToString();
            objAppraisal.Quarter = ViewState["Quarter"].ToString();
        ...
        private string MakeXml(GridView gvList)
        {
        ...
        protected void btnSubmitAll_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (confirmValue == "Yes")
                {
                    ...
                    //CheckBox chckheader = (CheckBox)GVSELF.HeaderRow.FindControl("chkSelectAll");
                    //foreach (GridViewRow row in GVSELF.Rows)
                    //{
                    ...
                    if (drActionAll.SelectedValue != "")
                    {
                        ...
                        {
                            ds = objAppraisal.UpdateParamApprisalTraninAndDevHODF(Column, Convert.ToString(Session["sCompID"]), (string)(Session["sEmpCode"]), "1");
            ...
            try
            {
                ...
                if (action == "Approve")
                {
                    using (MailMessage empMail = new MailMessage())
                    {
                        ...
                        string subject = "Do Not Reply: PMS - Training And Development Approved";
                        string empBody =
                        "Dear Sir/Madam,<br/><br/>" +
                        "This is to inform you that your Training And Development for " + Column + " has been approved by your HOD.<br/><br/>" +
                    ...
                    using (MailMessage rmMail = new MailMessage())
                    {
                        ...
                        string rmBody =
                        "Dear Sir/Madam,<br/><br/>" +
                        "This is to inform you that Training And Development for " + Column + " has been approved by HOD for <strong>Mr. " + makerName + "</strong>.<br/><br/>" +
                        "<strong>Portal Access:</strong> <a href='https://npl.sequelgroup.co.in/ESS/Login.aspx'>https://npl.sequelgroup.co.in/ESS/Login.aspx</a><br/><br/>" +
                ...
                else if (action == "Reject")
                {
                    using (MailMessage empMail = new MailMessage())
                    {
                        ...
                        string subject = "Do Not Reply: PMS - Training And Development Rejected";
                        string empBody =
                        "Dear Sir/Madam,<br/><br/>" +
                        "This is to inform you that your Training And Development for " + Column + " has been rejected by your HOD.<br/><br/>" +
                    ...
                    using (MailMessage rmMail = new MailMessage())
                    {
                        ...
                        string rmBody =
                        "Dear Sir/Madam,<br/><br/>" +
                        "This is to inform you that Training And Development for " + Column + " has been rejected by HOD for <strong>Mr. " + makerName + "</strong>.<br/><br/>" +
                        "<strong>Portal Access:</strong> <a href='https://npl.sequelgroup.co.in/ESS/Login.aspx'>https://npl.sequelgroup.co.in/ESS/Login.aspx</a><br/><br/>" +
                        "Thank you for your prompt attention to this matter.<br/><br/>" +
                        "<strong>With Best Regards,<br/>HR Team</strong>";
                    ...
                    using (MailMessage hodMail = new MailMessage())
                    {
                        ...
                        string hodBody =
                        "Dear Sir/Madam,<br/><br/>" +
                        "This is to inform you that Training And Development for " + Column + " has been rejected for <strong>Mr. " + makerName + "</strong>.<br/><br/>" +
                        "<strong>Portal Access:</strong> <a href='https://npl.sequelgroup.co.in/ESS/Login.aspx'>https://npl.sequelgroup.co.in/ESS/Login.aspx</a><br/><br/>" +
                        "Thank you for your prompt attention to this matter.<br/><br/>" +
                        "<strong>With Best Regards,<br/>HR Team</strong>";
