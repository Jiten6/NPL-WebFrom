<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="LeaveHoliday.aspx.cs" Inherits="NewPortal2023.ESS.LeaveHoliday1" %>
                                ...
                                <ContentTemplate>
                                    <div id="form1" runat="server">
                                        ...
                                        <div style="margin-top: 20px">
                                            <label id="lbldrp" class="col-sm-3 labels">Search by Year :-</label>
                                        ...
                                        <div id="OtherDetails" visible="true" runat="server">
                                           <%-- <asp:GridView ID="gvLeave" runat="server" BorderWidth="0px" CssClass="table4" HorizontalAlign="Left"
                                                ToolTip="Holiday List" OnRowDataBound="gvLeave_RowDataBound">--%>
                                            <asp:GridView ID="gvLeave" runat="server" AutoGenerateColumns="False"
                                                HorizontalAlign="Left" ToolTip="Approved OT/CO" CellPadding="5" OnRowDataBound="gvLeave_RowDataBound"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Date">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDt" runat="Server" style="display: block; text-align: center;" Text='<%# Eval("Date") %>' />
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Description">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDesc" runat="Server" style="display: block; text-align: center;" Text='<%# Eval("Description") %>' />
                                                        </ItemTemplate>
                                                        <ItemStyle CssClass="GridViewItem" BackColor="white" HorizontalAlign="Left" />
                                                        <HeaderStyle CssClass="GridViewHeader" />
                                                    </asp:TemplateField>
