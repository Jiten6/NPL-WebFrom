<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="IncrementLetterSingle.aspx.cs" Inherits="NewPortal2023.ESS.IncrementLetterSingle" %>
                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <header class="panel-heading" style="background-color: darkcyan">
                            <h3 style="color: white">Increment Letter</h3>
                        </header>
                                ...
                                <ContentTemplate>
                                    <div id="form1" runat="server">
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <div id="year" runat="server"  class="form-group">
