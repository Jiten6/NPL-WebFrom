...
{
    public partial class LeaveStructureHR : System.Web.UI.Page
    {
        ...
        private void FillLeave()
        {
            ...
            if (Session["MessageExec"] != null)
            {
                ...
                gvLeave.DataBind();
                OtherDetails.Visible = true;
                divLeaveOherComp.Visible = false;
            }
            ...
            else
            {
                type = "";
                dsInv = objInv.GetLeaveDetails((string)Session["sCompID"], (string)Session["sEmpID"], type);
                gvLeaveOtherComp.DataSource = dsInv;
                gvLeaveOtherComp.DataBind();
                OtherDetails.Visible = false;
                divLeaveOherComp.Visible = true;
            }
        }
