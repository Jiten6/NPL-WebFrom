<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="DomesticSupporting.aspx.cs" Inherits="NewPortal2023.ESS.DomesticSupporting" %>
            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading" style="background-color: darkcyan">
                        <h3 style="color: white">Domestic Supporting</h3>
                    </header>
                                ...
                                <div id="form1" runat="server">
                                    ...
                                    <section class="content" runat="server" id="SectionList">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <label style="font-size: 30px;">List Of Domestic Supporting Claim</label>
                                            ...
                                            <asp:GridView ID="gvDomClaim" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Claim Date" HeaderStyle-Width="74.2px">
                                                        <ItemTemplate>
                                                            <asp:Label ID="txtClmDate" CssClass="form-group" Style="width: 100%;" runat="Server" Text='<%# Eval("CreateDate") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
