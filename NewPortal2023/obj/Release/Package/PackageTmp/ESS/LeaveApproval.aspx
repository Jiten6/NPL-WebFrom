<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="LeaveApproval.aspx.cs" Inherits="NewPortal2023.ESS.LeaveApproval1" %>
                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <header class="panel-heading" style="background-color: darkcyan">
                            <h3 style="color: white">Leave Approval</h3>
                        </header>
                                ...
                                <ContentTemplate>
                                    <div id="form1" runat="server">
                                        ...
                                        BorderStyle="Solid" BorderWidth="1px" Font-Names="Arial" Font-Size="12px" class="table table-bordered table-condensed">--%>
                                            <asp:GridView ID="gvLeave" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblempId" runat="Server" Text='<%# Eval("EMP_AID") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Employee Name">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblEmp" runat="Server" Text='<%# Eval("Employee") %>' />
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="CR_Date" Visible="false">
                                                        <ItemStyle CssClass="GridViewItem" HorizontalAlign="Center" Width="250px" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCr_Date" runat="Server" Text='<%# Eval("CR_DATE") %>' />
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="GridViewHeader" />
                                                    </asp:TemplateField>
                                                    <asp:HyperLinkField DataNavigateUrlFields="Cid" DataNavigateUrlFormatString="LeaveApplication.aspx?Id={0}"
                                                ...
                                                <EmptyDataTemplate>
                                                    <table id="EmptyTable0" runat="server" cellpadding="0" cellspacing="0" class="GridViewEmpty">
                                                        <tr>
                                                            <td class="GridViewHeader" style="width: 150px">Employee
                                                            </td>
                                                            <td class="GridViewHeader" style="width: 90px">From Date
                                                            </td>
                                                            <td class="GridViewHeader" style="width: 90px">To Date
                                                            </td>
                                                            <td class="GridViewHeader" style="width: 70px">Leave Type
                                                            </td>
                                                            <td class="GridViewHeader" style="width: 150px">Reason
                                                            </td>
                                                            ...
                                                            <td class="GridViewHeader" style="width: 90px">Status
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </EmptyDataTemplate>
                                        ...
                                        <div class="form-group" style="text-align: center;">
                                            ...
                                            <div style="display: inline-block; text-align: left;">
                                                <asp:DropDownList ID="drpStatus" runat="server" OnSelectedIndexChanged="drpStatus_TextChanged" AutoPostBack="true" CssClass="form-control input-sm-3" Width="150px"></asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-sm-12" style="text-align: center;">
                                            <asp:Button ID="btnSubmit" Enabled="false" CssClass="btn btn-success" runat="server" Text="Submit" OnClick="btnSubmit_Click" OnClientClick="this.disabled=true;" UseSubmitBehavior="false" />
                                        </div>

               

                                        <div class="form-group col-sm-12" style="text-align: center;">
                                            <asp:Button ID="lnkApp" Enabled="true" CssClass="btn btn-warning" runat="server" Text="View Approved List" OnClick="lnkApp_Click" OnClientClick="this.disabled=true;" UseSubmitBehavior="false" />
                                        </div>

                                        <div id="divLeaveAppr" visible="false" runat="server">
                                            <%--<asp:GridView ID="gvLeaveAppr" runat="server" BorderWidth="0px" CssClass="table4" HorizontalAlign="Left"
                                        ...
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSelect" runat="Server" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Remarks">
                                                        <ItemStyle CssClass="GridViewItem" HorizontalAlign="Center" Width="250px" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRmk" runat="Server" Text='<%# Eval("REMARKS") %>' />
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="GridViewHeader" />
                                                    </asp:TemplateField>
