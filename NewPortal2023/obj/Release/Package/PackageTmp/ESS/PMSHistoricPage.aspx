<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="PMSHistoricPage.aspx.cs" Inherits="NewPortal2023.ESS.PMSHistoricPage" %>
                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <header class="panel-heading" style="background-color: darkcyan">
                            <h3 style="color: white">PMS Historic Report</h3>
                        </header>
                                ...
                                <ContentTemplate>
                                    <div id="form1" runat="server">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                  <asp:Button ID="btnGenerateReport" runat="server" AutoPostBack="true" OnClick="btnGenerateReport_Click" Text="Generate PMS Historic Report" CssClass="btn btn-success" Width="300px" />
                                            </div>

                                            
                                            <div class="col-sm-3">
                                                <asp:Button ID="btnGenerateReportAllEmp" runat="server" AutoPostBack="true" OnClick="btnGenerateReportAllEmp_Click" Text="Generate PMS Last Promotion Report" CssClass="btn btn-info" Width="300px" />
                                            </div>

                                        </div>

                                       <%-- <div id="divPMS" runat="server" class="form-group col-sm-12" style="text-align: left">
                                          
                                        </div>

                                        <div id="divPMSAll" runat="server" class="form-group col-sm-12" style="text-align: left">
