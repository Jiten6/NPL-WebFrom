<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="ApprovalHODKeyAccomploshments.aspx.cs" Inherits="NewPortal2023.ESS.ApprovalHODKeyAccomploshments" %>
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="flex-grow-1">
                                <header class="panel-heading" style="background-color: darkcyan">
                                    <h3 style="color: white">KEY ACCOMPLISHMENTS APPROVAL(HOD)</h3>
                                </header>
                                                                        ...
                                                                        <asp:GridView ID="grKey" runat="server" OnRowDataBound="grKey_RowDataBound" ToolTip="SECTION II (a)" AutoGenerateColumns="False" Class="table table-bordered table-striped">
                                                                            ...
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Major contributions Achievements not covered under KRAs for the year">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtMajor" ReadOnly="true" TextMode="MultiLine" CssClass="form-group" Style="background-color: #f0f0f0; color: #888; border: 1px solid #ddd; width: 100%;" runat="Server" Text='<%# Eval("Major_contributions_Achievements_not_covered_under_KRAs_for_the_year") %>' />
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Remarks">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtRmk" ReadOnly="true" TextMode="MultiLine" CssClass="form-group" Style="background-color: #f0f0f0; color: #888; border: 1px solid #ddd; width: 100%;" runat="Server" Text='<%# Eval("REMARKS") %>' />
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Appraisers comments">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtRptRmk" ReadOnly="true" TextMode="MultiLine" Style="background-color: #f0f0f0; color: #888; border: 1px solid #ddd; width: 100%;" runat="Server" Text='<%# Eval("Appraisers_comments") %>' />
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                            ...
                                                            <asp:LinkButton ID="lnkBtnDeleteRowKey" Text="Delete Selected" runat="server" Font-Bold="true" ForeColor="Blue"
                                                                OnClick="lnkBtnDeleteRowKey_Click" CssClass="Title" AutoPostBack="true" OnClientClick="showLoader();" />--%>
                                                                    ...
                                                                    <div id="divAction" runat="server" visible="false" class="row">
                                                                        <div class="modal-footer justify-content-between">
                                                                            ...
                                                                            <asp:Button ID="BtnSaveOne" runat="server" Visible="false" OnClick="BtnSaveOne_Click" Text="Save changes" CssClass="btn btn-success" AutoPostBack="true" OnClientClick="showLoader();" />
                                                                    ...
                                                                    <div id="divSubmitAll" runat="server" class="row">
                                                                ...
                                                                <label class="col-sm-1" id="lblRemarksAll">Remarks :-</label>
                                                                        ...
                                                                        <div class="col-sm-2 row">
                                                                            <asp:Button ID="btnSubmitAll" runat="server" CssClass="btn btn-success" AutoPostBack="true" OnClick="btnSubmitAll_Click" Text="Submit" OnClientClick="Confirm(); showLoader();" />
                                                                    ...
                                                                    <div class="modal-footer justify-content-between" style="text-align: center">
                                                                        <asp:Button ID="btnList" runat="server" AutoPostBack="true" OnClick="btnList_Click" Text="View Employee List" CssClass="btn btn-info" OnClientClick="showLoader();" />
                                                                    </div>
                                                                ...
                                                                <Triggers>
                                                                    ...
                                                                    <asp:PostBackTrigger ControlID="grKey" />
