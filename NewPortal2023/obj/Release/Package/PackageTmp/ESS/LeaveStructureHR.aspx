<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="LeaveStructureHR.aspx.cs" Inherits="NewPortal2023.ESS.LeaveStructureHR" %>
                                ...
                                <ContentTemplate>
                                    <div id="form1" runat="server">
                                        ...
                                        <div class="form-group">
                                            <asp:LinkButton ID="lnkLeave" runat="server" Font-Size="Medium" ForeColor="DarkCyan">Leave Structure Year 2023-24</asp:LinkButton>
                                        </div>

                                        <div class="form-group" id="btnDtails" runat="server" visible="false">
                                            <asp:Button ID="btnExec" runat="server" Text="Executive" class="btn btn-info" ForeColor="#205A94" OnClick="btnExec_Click" />
                                            <asp:Button ID="btnWorkMen" runat="server" Text="WorkMen" class="btn btn-info" ForeColor="#205A94" OnClick="btnWorkMen_Click" />
                                        </div>
                                        ...
                                        <div id="divLeaveOherComp" visible="false" runat="server">
                                            <%--<asp:GridView ID="gvLeaveOtherComp" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                                CssClass="table4" HorizontalAlign="Left" ToolTip="Leave Structure">--%>
                                            <asp:GridView ID="gvLeaveOtherComp" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Leave Code">
                                                        <ItemStyle CssClass="GridViewItem" Width="100px" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCode" runat="Server" Text='<%# Eval("LEAVE_CODE") %>' />
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="GridViewHeader" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Leave Name">
                                                        <ItemStyle CssClass="GridViewItem" Width="400px" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDesc" runat="Server" Text='<%# Eval("LEAVE_NAME") %>' />
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="GridViewHeader" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Allocated">
                                                        <ItemStyle CssClass="GridViewItem" HorizontalAlign="Center" Width="130px" />
                                                        <ItemTemplate>
                                                            <asp:Label ID="txtAll" runat="Server" Text='<%# Eval("ALLOCATED") %>' />
                                                            <%--<asp:TextBox ID="txtAll" runat="server" CssClass="input" MaxLength="2" oncopy="return false"
                                                                            onpaste="return false" onkeypress="return validateFloat(event, 0);" ToolTip="Enter allocated details"
                                                                            Text='<%# Eval("ALLOCATED") %>' Width="130px"></asp:TextBox>--%>
                                                        </ItemTemplate>
                                                        <HeaderStyle CssClass="GridViewHeader" />
                                                    ...
                                                    <%-- <asp:TemplateField HeaderText="Is CarryForward">
                                                                    <ItemStyle CssClass="GridViewItem" HorizontalAlign="Center" Width="130px" />
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox ID="chkSel" runat="server" ToolTip="Select if carry forwared leave">
                                                                        </asp:CheckBox>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle CssClass="GridViewHeader" />
                                                                </asp:TemplateField>--%>
                                                ...
                                                <EmptyDataTemplate>
                                                    <table id="EmptyTable0" runat="server" cellpadding="0" cellspacing="0" class="GridViewEmpty">
                                                        <tr>
                                                            ...
                                                            <%-- <td class="GridViewHeader" style="width: 130px">
                                                                            Is CarryForward
                                                                        </td>--%>
                                                        </tr>
                                                    </table>
