<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="ApprovalHODTrainingAndDevelopment.aspx.cs" Inherits="NewPortal2023.ESS.ApprovalHODTrainingAndDevelopment" %>
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="flex-grow-1">
                                <header class="panel-heading" style="background-color: darkcyan">
                                    <h3 style="color: white">Training And Development Approval(HOD)</h3>
                                </header>
                                                ...
                                                <div class="card-body" style="margin: 20px">
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                    ...
                                                                    <asp:GridView ID="GVSELF" runat="server" ToolTip="Training & Development Plans" AutoGenerateColumns="False" Class="table table-bordered table-striped">
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Identified By Appraiser">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txtAssMAppriser" TextMode="MultiLine" ReadOnly="true" CssClass="form-group" Style="background-color: #f0f0f0; color: #888; border: 1px solid #ddd; width: 100%;" runat="Server" Text='<%# Eval("AssMAppriser") %>' />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>

                                                                            <asp:TemplateField HeaderText="HR Remarks" Visible="false">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txtSelfHRRmk" TextMode="MultiLine" ReadOnly="true" CssClass="form-group" Style="background-color: #f0f0f0; color: #888; border: 1px solid #ddd; width: 100%;" runat="Server" Text='<%# Eval("SelfHRRmk") %>' />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                        </Columns>
                                                                        <EmptyDataTemplate>
                                                            ...
                                                            <div class="col-sm-1">
                                                                ...
                                                                <div id="divAction" runat="server" class="row">
                                                                    <div class="modal-footer justify-content-between">
                                                                        <asp:Button ID="BtnSaveChanges" runat="server" Visible="false" OnClick="BtnSaveChanges_Click" Text="Save changes" CssClass="btn btn-success" AutoPostBack="true" OnClientClick="showLoader();" />
                                                        ...
                                                        <Triggers>
                                                            ...
                                                            <asp:PostBackTrigger ControlID="GVSELF" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
