<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="PMSStatusReport.aspx.cs" Inherits="NewPortal2023.ESS.PMSStatusReport" %>
                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <header class="panel-heading" style="background-color: darkcyan">
                            <h3 style="color: white">PMS Status Report</h3>
                        </header>
                                    ...
                                    <div class="col-lg-12 row" style="margin-left:5px">
                                        <div class="col-lg-6 row">
                                            <div class="col-sm-6" style="margin-left: -20px">
                                                <asp:Label ID="Label3" runat="server" Text="Report Type :" CssClass="card-title" Style="font-size: 20px;"></asp:Label>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                                    <asp:DropDownList ID="drpReportType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpReportType_SelectedIndexChanged" CssClass="form-control input-sm-3" Enabled="true" onchange="showLoader();">
                                                        <asp:ListItem Value="">Select One</asp:ListItem>
                                                        <asp:ListItem Value="CycleWise">Cycle Wise</asp:ListItem>
                                                        <asp:ListItem Value="YearWise">Year Wise</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-lg-6 row" id="divFinYear" runat="server" visible="false">
                                            <div class="col-sm-6" style="margin-left: -20px">
                                        ...
                                        <div id="form1" runat="server">
                                            ...
                                            <div id="divAboveSr" runat="server" class="form-group row" style="margin: 10px">
                                                ...
                                                <div class="form-group col-sm-12" style="text-align: center">
                                                    <asp:Button ID="btnGenerateReport" runat="server" AutoPostBack="true" OnClick="btnGenerateReport_Click" OnClientClick="showLoader();" Text="Generate PMS Status Report" CssClass="btn btn-success" Width="300px" />
                                                </div>
