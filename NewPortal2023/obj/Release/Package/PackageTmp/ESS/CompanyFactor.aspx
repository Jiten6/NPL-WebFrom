<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="CompanyFactor.aspx.cs" Inherits="NewPortal2023.ESS.CompanyFactor" %>
                                        ...
                                        <div class="card-body" style="margin: 20px">
                                            <asp:UpdatePanel ID="updProofEdit" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <div class="col-sm-12 form-group row" style="margin-left: -30px">
                                                        ...
                                                        <%--OnClientClick="LinkFinancialsClicked()"--%>
                                                    ...
                                                    <div id="divKRAUpload" runat="server" class="form-group row" visible="true">
                                                        <div class="col-12">
                                                            <h3 class="card-title">Upload KRA </h3>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <%--<asp:LinkButton ID="lnkSample" runat="server" Style="color: blue" OnClick="lnkSample_Click">Download Template File</asp:LinkButton>--%>
                                                                </div>
                                                                <div class="col-sm-6" style="text-align: left; margin-left: -70px">
                                                                    ...
                                                                    <asp:Button ID="btnInsert" runat="server" CssClass="btn btn-primary" OnClientClick="showLoader();" Text="Upload" OnClick="btnInsert_Click" />
                                                                    <%--<asp:Button ID="btnUpload" runat="server" CssClass="btn btn-warning" OnClientClick="showLoader();" Text="Update" OnClick="btnUpload_Click" />--%>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <asp:UpdatePanel ID="updListAdd" runat="server">
                                                            <ContentTemplate>
                                                                    ...
                                                                    <asp:GridView ID="gvSteps" runat="server" OnRowUpdating="gvSteps_RowUpdating" OnRowCancelingEdit="gvSteps_RowCancelingEdit" OnRowDataBound="gvSteps_RowDataBound" OnRowEditing="gvSteps_RowEditing" AutoGenerateColumns="False"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Area" Visible="false">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txtArea" runat="Server" CssClass="form-control input-sm datepicker" TextMode="MultiLine" Text='<%# Eval("AREA") %>' /><%--<%# Eval("AREA") %>--%>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Ach%" Visible="true">
                                                                                <ItemTemplate>
                                                                            ...
                                                                            <asp:TemplateField Visible="false">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="txtaid" runat="Server" CssClass="form-control input-sm" Text='<%# Eval("Appraisal_AID") %>' /><%-- <%# Eval("Achievement_REMARKS") %>--%>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                        </Columns>
                                                                        <EmptyDataTemplate>
                                                                ...
                                                                <%--<div class="col-sm-12 row" style="text-align:center">
                                                                    <asp:Label ID="Label1" runat="server" CssClass="col-sm-2" Text="Weightage :" Font-Bold="true" />
                                                                    <div Class="col-sm-2">
                                                                        <asp:TextBox ID="txtwhtg" runat="Server" CssClass="form-control input-sm" Text ='' Width="150px" />
                                                                    </div>
                                                                    <asp:Label ID="Label2" runat="server" CssClass="col-sm-2" Text="Ach% :" Font-Bold="true" Style="margin-left:-70px" />
                                                                    <div Class="col-sm-2">
                                                                        <asp:TextBox ID="txtAch" runat="Server" CssClass="form-control input-sm-2" Text ='' Width="150px" />
                                                                    </div>
