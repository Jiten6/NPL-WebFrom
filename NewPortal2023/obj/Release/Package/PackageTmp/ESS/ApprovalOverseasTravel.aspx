<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="ApprovalOverseasTravel.aspx.cs" Inherits="NewPortal2023.ESS.ApprovalOverseasTravel" %>
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <div id="divAirEco" runat="server" visible="false" class="form-group row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtchk1"
                                                                ValidationExpression="^\d+(\.\d{1,2})?$"
                                                                ErrorMessage="Please enter a valid numeric value."
                                                                Display="Dynamic" ForeColor="Red" />
                                                        </div>
                                                    ...
                                                    <div id="dvgroup" runat="server" visible="false" class="form-group">
                                                        <div class="col-sm-12">
                                                            <label id="lblgroup" runat="server" visible="false" style="font-size: 20px;"><u>Daily Reimbursement Amount in Rs. (Per day)</u></label>
                                                            <br />
                                                            <br />
                                                    ...
                                                    <div id="divEntertainment" runat="server" class="form-group" visible="false">
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <label style="font-size: 20px;"><u>Entertainment</u></label>
                                                            <br />
                                                            <br />
                                                    ...
                                                    <div id="divWardrobe" class="form-group" runat="server" visible="false" >
                                                        <div class="col-sm-12">
                                                            <br />
                                                            <label style="font-size: 20px;"><u>Wardrobe Allowance</u></label>
                                                            <br />
                                                            <br />
                                                        ...
                                                        <div class="row" id="div11" runat="server" visible="false">
