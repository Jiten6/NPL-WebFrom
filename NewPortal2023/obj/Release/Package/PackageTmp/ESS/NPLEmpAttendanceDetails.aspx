<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="NPLEmpAttendanceDetails.aspx.cs" Inherits="NewPortal2023.ESS.NPLEmpAttendanceDetails" EnableEventValidation="false" %>
                ...
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading" style="background-color: darkcyan">
                            <h3 style="color: white">Attendance Report</h3>
                        </header>
                            ...
                            <div id="trSubmit1" runat="server">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12" style="text-align: center; margin-top: 50px">
                                        <asp:Button ID="btnGenerateAttendanceReport" runat="server" CssClass="btn btn-success" Text="Generate Attendance Report"
