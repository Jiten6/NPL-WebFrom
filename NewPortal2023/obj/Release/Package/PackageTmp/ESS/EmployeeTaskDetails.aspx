                                                                                ...
                                                                                <asp:GridView ID="gvSteps" runat="server" OnRowUpdating="gvSteps_RowUpdating" OnRowCancelingEdit="gvSteps_RowCancelingEdit" OnRowDataBound="gvSteps_RowDataBound" OnRowEditing="gvSteps_RowEditing" AutoGenerateColumns="False"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Weightage" Visible="true">
                                                                                            <ItemTemplate>
                                                                                                <asp:TextBox ID="txtWeightage" runat="Server" CssClass="form-control input-sm" TextMode="MultiLine" Text='<%# Eval("Weightage") %>' />
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Achieved Weightage %" Visible="true">
                                                                                            <ItemTemplate>
                                                                                                <asp:TextBox ID="txtAchPer" runat="Server" CssClass="form-control input-sm datepicker" TextMode="MultiLine" Text='<%# Eval("AchievedWeightage_Perct") %>' />
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
