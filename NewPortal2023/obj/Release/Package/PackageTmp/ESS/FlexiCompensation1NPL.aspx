<%@ Page Title="" Language="C#" MasterPageFile="~/ESS/ESS.Master" AutoEventWireup="true" CodeBehind="FlexiCompensation1NPL.aspx.cs" Inherits="NewPortal2023.ESS.FlexiCompensation1NPL" %>
                        ...
                        <div class="panel-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" EnableViewState="true">
                                <ContentTemplate>
                                    <div id="form1" runat="server">
                                        ...
                                        <div id="divUplSupp" runat="server">
                                            ...
                                            <asp:LinkButton ID="lnkdriversalary" runat="server" Style="font-weight: bold;" OnClick="lnkdriversalary_Click" ForeColor="Blue">Download Driver Salary Receipt</asp:LinkButton>
                                            <br />
                                ...
                                <Triggers>
                                    ...
                                    <asp:PostBackTrigger ControlID="lnkdriversalary" />
                                </Triggers>
                            </asp:UpdatePanel>
